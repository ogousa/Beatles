...
AlbumController.$inject = ['$scope', '$routeParams', 'albumsInfo', '$location', '$anchorScroll', 'anchorSmoothScroll'];

function AlbumController($scope, $routeParams, albumsInfo, $location, $anchorScroll, anchorSmoothScroll) {
